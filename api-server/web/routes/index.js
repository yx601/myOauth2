...
module.exports = function (app) {
  ...
  app.get('/OAuth2/login',login.checkDirectAccess,login.showLogin);
  app.get('/OAuth2/logout',login.logout);
  app.post('/OAuth2/login',login.checkLoginParams,login.showLogin);
  // OAuth2授权
